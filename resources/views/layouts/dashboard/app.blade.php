            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.logout') }}" class="nav-link"
                        onclick="event.preventDefault();document.getElementById('logout-form').submit();">@lang('dashboard.logout')</a>
        ...
        $(document).ready(function() {
            ...
            function formatItem(item) {
                ...
                $.each(item.fields, function(key, field) {
                    markup += "<div class='searchable-fields'>" + item.fields_formatted[field] + " : " +
                        item[field] + "</div>";
                });
                markup += "</div>";
                return markup;
