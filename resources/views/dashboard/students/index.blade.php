                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item">
                                <a href="{{ route('dashboard.welcome') }}"><i class="fa fa-home"></i> @lang('dashboard.dashboard')</a>
                            </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-0 align-middle">
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            @can('update-students')
                                                                <a
                                                                    href="{{ route('dashboard.students.edit', $student->id) }}"class="btn btn-info">
