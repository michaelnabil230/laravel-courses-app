                            ...
                            <div class="card-body">
                                <form action="{{ route('dashboard.courses.update', $course->id) }}" method="post">
                                        ...
                                        <select name="location_id" id="locations" placeholder="@lang('dashboard.locations')"
                                            ...
                                            @foreach ($locations as $location)
                                                <option value="{{ $location->id }}"
                                                    {{ $course->location_id == $location->id ? 'selected' : '' }}>
                                                    {{ $location->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="{{ $locale }}[name]"
                                                value="{{ $course->translate($locale)->name }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="{{ $locale }}[title]" id="{{ $locale }}_title"
                                                class="form-control @error($locale . '.title') is-invalid @enderror" placeholder="@lang('dashboard.' . $locale . '.title')">{{ $course->translate($locale)->title }}</textarea>
                                            @error($locale . '.title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="start_at" value="{{ $course->start_at }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="end_at" value="{{ $course->end_at }}"
